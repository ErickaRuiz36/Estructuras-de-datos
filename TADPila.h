...
elemento Element(pila *s, int n);	//Consultar elemento (Obtener el "elemento" de una posición de la pila sin extraerlo de la pila)
void Copy(pila *s, pila *t);		//Copiar (Copiar los elementos de una pila en otra)
void Flip(pila *s);					//Voltear (Invertir los elementos de la pila)
